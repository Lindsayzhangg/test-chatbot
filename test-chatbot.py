...
rag_retrieval_chain = create_retrieval_chain(history_aware_retriever, question_answer_chain)
...
if user_input:
    ...
    with st.spinner("Thinking..."):
        bot_response = rag_retrieval_chain.invoke({"input": user_input}, config={"configurable": {"session_id": "test"}})["answer"]
